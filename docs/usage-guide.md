...
```text
资料检查 -> 章节骨架 -> 第一个小块讲解 -> 1 个快速检查 -> 近迁移题 -> 你作答 -> 反馈 -> 卡片
```

如果你已经学过一点，才适合让 AI 先做前置检查：

```text
我已经预习过这一章。请先问我 3 个前置检查问题，再决定讲解深度。
```
...
```text
使用 ai-study-workflow，基于 local-materials/course-files/course.pptx。
我走新知识学习模式，而且还没学过。请先给章节骨架并讲第一个最小知识块。
最多问我 1 个快速检查问题。
```
